...
| RISK-003 | Heater relay stuck ON | High | Low/Medium | Detect PT50 rise while heater command OFF; hard fault; independent cutoff recommended | Open |
| RISK-004 | Temperature not rising while heater ON | Medium | Medium | Hard fault if less than 2 C rise within 5 min | Open |
